...
#define USB_GENERIC_VENDOR  0x18D1  // Google LLC.
#define USB_GENERIC_PRODUCT_ALPAKKA 0x9400  // Stadia Controller.
#define USB_GENERIC_PRODUCT_DONGLE  0x9400  // Stadia Controller.
...
// Stadia Controller Rev. A gamepad report descriptor used only by the
// PROTOCOL_GENERIC USB backend. Report ID 3, 10-byte input payload.
#define TUD_HID_REPORT_DESC_GAMEPAD_STADIA(...) \
  0x05, 0x01, \
  0x09, 0x05, \
  0xA1, 0x01, \
    __VA_ARGS__ \
    ...
    0x75, 0x01, \
    0x95, 0x0F, \
    0x09, 0x12, 0x09, 0x11, 0x09, 0x14, 0x09, 0x13, \
    0x09, 0x0D, 0x09, 0x0C, 0x09, 0x0B, 0x09, 0x0F, \
    0x09, 0x0E, 0x09, 0x08, 0x09, 0x07, 0x09, 0x05, \
    0x09, 0x04, 0x09, 0x02, 0x09, 0x01, \
    0x81, 0x02, \
    0x75, 0x01, \
    0x95, 0x01, \
    0x81, 0x01, \
